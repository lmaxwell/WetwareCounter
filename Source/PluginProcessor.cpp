...

{
    ...
    if (thisInstanceCount > 1)
    {
        ...
        lastBarStart = -1;
        //addParameter(g_fragment=new AudioParameterChoice("g_fragment","g_Fragment",{"1","64"},1));
        addParameter(addParam=new AudioParameterBool("ADD","ADD",false));
        addParameter(clearParam=new AudioParameterBool("CLEAR","CLEAR",false));
        //dynamic_cast<FloatParameter*>(getParameters().getUnchecked(513))->setName("Yes!");
    }
}
